...
def parse_args():
    ...
    #     type=str,
    #     required=True,
    #     choices=["full-finetune", "lora", "qlora,2", "loftq,2", "qera,2", "qlora,4", "loftq,4", "qera,4"],
    # )
    # parser.add_argument("--bnb_config_yaml", type=str, default=None)  # this is required by qera, qlora, and loftq
    parser.add_argument(
